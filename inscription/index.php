...
<body>
    ...
    <h3  class="subtitle"style="text-align:center;">book your home everywhere</h3>   
    ...
    <main>
      ...
      <!-- <img src="rectangle.png" class="img-fluid" alt="..."> -->
    </main>
    <div class="rectangle">
     <img src="home2.png" class="img-fluid" alt="..." style="margin-left:-5.5em; width:39em; height:20em; margin-top:7.3em;" >
     <img src="rania.png" class="img-fluid" alt="..." style="width:15em; margin-left:19em; margin-top:-11em; ">
     <h5>RANIA EL BALQ</h5>
    </div>
</body>
</html>